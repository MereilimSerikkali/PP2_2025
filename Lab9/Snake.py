...
def generate_food(snake_list):
    """Generate food at random position that doesn't overlap with snake or walls"""
    while True:
...
def gameLoop():
    ...
    foods_needed_for_next_level = 3  # Number of foods to eat to advance to next level
